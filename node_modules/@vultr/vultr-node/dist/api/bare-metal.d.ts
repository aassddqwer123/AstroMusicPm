...
export namespace createInstance {
    ...
    export namespace parameters_1 {
        ...
        namespace persistent_pxe {
            const type_17: string;
            export { type_17 as type };
        }
        namespace attach_vpc2 {
            const type_18: string;
            export { type_18 as type };
        }
        namespace detach_vpc2 {
            const type_19: string;
            export { type_19 as type };
        }
        namespace enable_vpc2 {
...
export namespace getInstanceIpv4Addresses {
    const url_5: string;
    export { url_5 as url };
...
export namespace getInstanceIpv6Addresses {
    const url_6: string;
    export { url_6 as url };
...
export namespace rebootInstances {
    ...
    export namespace parameters_13 {
        export namespace baremetal_ids_1 {
            const type_23: string;
            export { type_23 as type };
        }
        export { baremetal_ids_1 as baremetal_ids };
    }
...
export namespace startInstances {
    ...
    export namespace parameters_14 {
        export namespace baremetal_ids_2 {
            const type_24: string;
            export { type_24 as type };
        }
        export { baremetal_ids_2 as baremetal_ids };
    }
...
export namespace getInstanceAvailableUpgrades {
    const url_16: string;
...
export namespace getInstanceVncUrl {
    const url_17: string;
