...
export namespace createStorage {
    const url_1: string;
    export { url_1 as url };
...
export namespace deleteStorage {
    const url_3: string;
    export { url_3 as url };
...
export namespace updateStorage {
    const url_4: string;
    export { url_4 as url };
...
export namespace attachStorage {
    const url_5: string;
    export { url_5 as url };
...
export namespace detachStorage {
    const url_6: string;
    export { url_6 as url };
