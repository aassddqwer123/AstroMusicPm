export function initialize(config: any): {
    ...
    bareMetal: {
        ...
        attachVpc2ToInstance: (parameters: any) => any;
        detachVpc2FromInstance: (parameters: any) => any;
        listInstanceVpc2: (parameters: any) => any;
    };
    billing: {
    ...
    databases: {
        ...
        listDatabases: (parameters: any) => any;
        createDatabase: (parameters: any) => any;
        getDatabase: (parameters: any) => any;
        updateDatabase: (parameters: any) => any;
        deleteDatabase: (parameters: any) => any;
        listDatabaseUsers: (parameters: any) => any;
        createDatabaseUser: (parameters: any) => any;
        getDatabaseUser: (parameters: any) => any;
        updateDatabaseUser: (parameters: any) => any;
        deleteDatabaseUser: (parameters: any) => any;
        listDatabaseDbs: (parameters: any) => any;
        createDatabaseDb: (parameters: any) => any;
        getDatabaseDb: (parameters: any) => any;
        deleteDatabaseDb: (parameters: any) => any;
        listMaintenanceUpdates: (parameters: any) => any;
        startMaintenanceUpdates: (parameters: any) => any;
        listServiceAlerts: (parameters: any) => any;
        viewMigrationStatus: (parameters: any) => any;
        databaseStartMigration: (parameters: any) => any;
        databaseDetachMigration: (parameters: any) => any;
        databaseAddReadReplica: (parameters: any) => any;
        getBackupInformation: (parameters: any) => any;
        databaseRestoreFromBackup: (parameters: any) => any;
        databaseFork: (parameters: any) => any;
        listConnectionPools: (parameters: any) => any;
        createConnectionPool: (parameters: any) => any;
        getConnectionPool: (parameters: any) => any;
        updateConnectionPool: (parameters: any) => any;
        deleteConnectionPool: (parameters: any) => any;
        listAdvancedOptions: (parameters: any) => any;
        updateAdvancedOptions: (parameters: any) => any;
        listAvailableVersions: (parameters: any) => any;
        startVersionUpgrade: (parameters: any) => any;
    };
    dns: {
    ...
    kubernetes: {
        ...
        upgrades: (parameters: any) => any;
        getKubernetesAvailableUpgrades: (parameters: any) => any;
    };
    objectStorage: {
    ...
    registries: {
        listRegistries: (parameters: any) => any;
        createRegistry: (parameters: any) => any;
        readRegistry: (parameters: any) => any;
        updateRegistry: (parameters: any) => any;
        deleteRegistry: (parameters: any) => any;
        listRepositories: (parameters: any) => any;
        readRepository: (parameters: any) => any;
        updateRepository: (parameters: any) => any;
        deleteRepository: (parameters: any) => any;
        createRegistryDockerCredentials: (parameters: any) => any;
        createRegistryDockerCredentialsKubernetes: (parameters: any) => any;
        listRegistryRegions: (parameters: any) => any;
        listRegistryPlans: (parameters: any) => any;
    };
    reservedIps: {
        getReservedIp: (parameters: any) => any;
        deleteReservedIp: (parameters: any) => any;
        updateReservedIp: (parameters: any) => any;
    ...
    vpcs: {
        getVpc: (parameters: any) => any;
        deleteVpc: (parameters: any) => any;
        updateVpc: (parameters: any) => any;
        listVpcs: (parameters: any) => any;
        createVpc: (parameters: any) => any;
    };
    vpc2: {
        getVpc: (parameters: any) => any;
        deleteVpc: (parameters: any) => any;
        ...
        listVpcs: (parameters: any) => any;
        createVpc: (parameters: any) => any;
        listVpcNodes: (parameters: any) => any;
        attachVpcNodes: (parameters: any) => any;
        detachVpcNodes: (parameters: any) => any;
    };
};
