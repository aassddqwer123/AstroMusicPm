export namespace getReservedIp {
    const url: string;
...
export namespace deleteReservedIp {
    const url_1: string;
    export { url_1 as url };
...
export namespace updateReservedIp {
    const url_2: string;
    export { url_2 as url };
...
export namespace listReservedIps {
    const url_3: string;
    export { url_3 as url };
...
export namespace createReservedIp {
    const url_4: string;
    export { url_4 as url };
...
export namespace attachReservedIp {
    const url_5: string;
    export { url_5 as url };
...
export namespace detachReservedIp {
    const url_6: string;
    export { url_6 as url };
...
export namespace convertInstanceIpToReservedIp {
    const url_7: string;
    export { url_7 as url };
