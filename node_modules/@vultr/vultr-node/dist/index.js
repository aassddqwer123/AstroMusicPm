exports.initialize = function (config) {
    ...
    var databases = require('./api/databases');
    ...
    var registries = require('./api/registries');
    ...
    var vpcs = require('./api/vpcs');
    var vpc2 = require('./api/vpc2');
    ...
    return {
        ...
        bareMetal: {
            ...
            attachVpc2ToInstance: createRequestFunction(bareMetal.attachVpc2ToInstance),
            detachVpc2FromInstance: createRequestFunction(bareMetal.detachVpc2FromInstance),
        ...
        databases: {
            ...
            listMaintenanceUpdates: createRequestFunction(databases.listMaintenanceUpdates),
            startMaintenanceUpdates: createRequestFunction(databases.startMaintenanceUpdates),
            ...
            databaseStartMigration: createRequestFunction(databases.databaseStartMigration),
            databaseDetachMigration: createRequestFunction(databases.databaseDetachMigration),
            databaseAddReadReplica: createRequestFunction(databases.databaseAddReadReplica),
            getBackupInformation: createRequestFunction(databases.getBackupInformation),
            databaseRestoreFromBackup: createRequestFunction(databases.databaseRestoreFromBackup),
            ...
            createConnectionPool: createRequestFunction(databases.createConnectionPool),
            getConnectionPool: createRequestFunction(databases.getConnectionPool),
            updateConnectionPool: createRequestFunction(databases.updateConnectionPool),
            deleteConnectionPool: createRequestFunction(databases.deleteConnectionPool),
            listAdvancedOptions: createRequestFunction(databases.listAdvancedOptions),
            updateAdvancedOptions: createRequestFunction(databases.updateAdvancedOptions),
            listAvailableVersions: createRequestFunction(databases.listAvailableVersions),
        ...
        instances: {
            ...
            attachVpc2ToInstance: createRequestFunction(instances.attachVpc2ToInstance),
            detachVpcFromInstance: createRequestFunction(instances.detachVpcFromInstance),
            detachVpc2FromInstance: createRequestFunction(instances.detachVpc2FromInstance),
        ...
        kubernetes: {
            ...
            getKubernetesAvailableUpgrades: createRequestFunction(kubernetes.getKubernetesAvailableUpgrades)
        },
        objectStorage: {
        ...
        registries: {
            ...
            createRegistryDockerCredentials: createRequestFunction(registries.createRegistryDockerCredentials),
            createRegistryDockerCredentialsKubernetes: createRequestFunction(registries.createRegistryDockerCredentialsKubernetes),
            listRegistryRegions: createRequestFunction(registries.listRegistryRegions),
